...
istSatz1(In,Antwort) :- match(ist,In,R1), person(P1,R1,R2), artikel(R2,R3),
beziehungswort(B,R3,R4), match(von,R4,R5), 
person(P2,R5,R6), istbeziehung(P1,P2,B,Antwort).
istSatz2(In,Antwort) :- match(ist,In,R1), person(P1,R1,R2), match(mit,R2,R3),
person(P2,R3,R6), sindbeziehung(P1,P2,R6,Antwort).
...
istSatz1(Frage,Antwort);istSatz2(Frage,Antwort).
